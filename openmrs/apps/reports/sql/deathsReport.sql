...
from patient pat
inner join obs o ON pat.patient_id = o.person_id
inner join concept_name cn on o.concept_id = cn.concept_id and cn.name = 'PR, Start date of ART program' and cn.concept_name_type = 'FULLY_SPECIFIED'
