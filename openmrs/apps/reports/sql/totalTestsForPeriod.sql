...
obs
INNER JOIN orders on obs.order_id = orders.order_id and orders.order_type_id = 3 and orders.order_action != 'DISCONTINUE' and  obs.order_id is not null and obs.concept_id not in
