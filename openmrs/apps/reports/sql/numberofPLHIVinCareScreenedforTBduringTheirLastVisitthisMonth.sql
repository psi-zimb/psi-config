SELECT/*Pivoting the table*/
    'Number of PLHIV in care screened for TB during their last visit this month' AS '-',
...
(
    ...
    FROM (
            ...
            from person per
                ...
                group by o.obs_id
         ) AS personPLSHIVScreenedforTB
        INNER JOIN person p ON p.person_id =  personPLSHIVScreenedforTB.person_id
           GROUP BY
           CASE
