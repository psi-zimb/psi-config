         ...
         "AIVC, Are you currently pregnant?": function(formName, formFieldValues) {
          ...
          "AIVC, Do you know the EDD?": function(formName, formFieldValues) {
               ...
               "AIVC,Have you ever experienced a drug allergy?": function(formName, formFieldValues) {
                ...
                "PR, Program": function (formName, formFieldValues) {
                      ...
                      if (conditionConcept == "PR, ART") {
                          ...
                          "PR, Is ART Program Active", "PR, Reason for Stopping ART Program");

                          conditions.hide.push("PR, Start date of Breast Feeding program", "PR, Start date of IPT (Isoniazid Preventive Therapy) program", 
                          ...
                          "PR, Breast Feeding Program Stop Date", "PR, IPT (Isoniazid Preventive Therapy) Program Stop Date", "PR, Pregnancy Program Stop Date","PR, PrEP Program Stop Date", 
                          "PR, TB Program Stop Date", "PR, Is Breast Feeding Program Active", "PR, Is IPT Program Active", "PR, Is Pregnancy Program Active", "PR, Is PrEP Program Active", 
                          "PR, Is TB Program Active", "PR, Reason for Stopping Breast Feeding Program", "PR, Reason for Stopping IPT Program", "PR, Reason for Stopping Pregnancy Program", 
           ...
           conditions.show.push("PR, Start date of Breast Feeding program", "PR, Breast Feeding Stage", "PR, Start date of Breast Feeding Stage", "PR, Breast Feeding Program Stop Date", 
            "PR, Is Breast Feeding Program Active", "PR, Reason for Stopping Breast Feeding Program");
           conditions.hide.push("PR, Start date of ART program", "PR, Start date of IPT (Isoniazid Preventive Therapy) program",  "PR, Start date of Pregnancy program", "PR, Start date of PrEP program", 
            ...
            "PR, Start date of TB Stage", "PR, IPT (Isoniazid Preventive Therapy) Program Stop Date", "PR, Pregnancy Program Stop Date","PR, PrEP Program Stop Date", "PR, TB Program Stop Date", "PR, Is IPT Program Active", 
            "PR, Is Pregnancy Program Active", "PR, Is PrEP Program Active", "PR, Is TB Program Active", "PR, Reason for Stopping IPT Program", "PR, Reason for Stopping Pregnancy Program", "PR, Reason for Stopping PrEP Program", 
            "PR, Reason for Stopping TB Program","PR, Is ART Program Active", "PR, Reason for Stopping ART Program");
         }
         else if (conditionConcept == "PR, IPT(Isoniazid Preventive Therapy)") {
           conditions.show.push("PR, Start date of IPT (Isoniazid Preventive Therapy) program", "PR, IPT (Isoniazid Preventive Therapy) Program Stop Date", "PR, Is IPT Program Active", 
           ...
           conditions.hide.push("PR, Start date of ART program", "PR, Start date of Breast Feeding program",  "PR, Start date of Pregnancy program", "PR, Start date of PrEP program", 
            ...
            "PR, TB Program Stop Date", "PR, Start date of ART Stage", "PR, ART Program Stop Date", "PR, Is Breast Feeding Program Active", "PR, Is Pregnancy Program Active", 
            "PR, Is PrEP Program Active", "PR, Is TB Program Active", "PR, Reason for Stopping Breast Feeding Program", "PR, Reason for Stopping Pregnancy Program", 
            "PR, Reason for Stopping PrEP Program", "PR, Reason for Stopping TB Program", "PR, Is ART Program Active", "PR, Reason for Stopping ART Program");
         }
            ...
            conditions.show.push("PR, Start date of Pregnancy program", "PR, Pregnancy Stage", "PR, Start date of Pregnancy Stage", "PR, Pregnancy Program Stop Date", 
              "PR, Is Pregnancy Program Active", "PR, Reason for Stopping Pregnancy Program");
            conditions.hide.push("PR, Start date of ART program", "PR, Start date of Breast Feeding program",  
              "PR, Start date of IPT (Isoniazid Preventive Therapy) program", "PR, Start date of PrEP program", "PR, Start date of TB program", 
              "PR, Breast Feeding Stage", "PR, ART Stage", "PR, TB Stage", "PR, Start date of Breast Feeding Stage", "PR, Start date of TB Stage", 
              "PR, Breast Feeding Program Stop Date", "PR, IPT (Isoniazid Preventive Therapy) Program Stop Date", "PR, PrEP Program Stop Date", "PR, TB Program Stop Date", "PR, Start date of ART Stage", 
              "PR, ART Program Stop Date", "PR, Is Breast Feeding Program Active", "PR, Is IPT Program Active", "PR, Is PrEP Program Active", 
              "PR, Is TB Program Active", "PR, Reason for Stopping Breast Feeding Program", "PR, Reason for Stopping IPT Program", "PR, Reason for Stopping PrEP Program", 
              "PR, Reason for Stopping TB Program", "PR, Is ART Program Active", "PR, Reason for Stopping ART Program");
         }
        else if (conditionConcept == "PR, PrEP") {
            conditions.show.push("PR, Start date of PrEP program", "PR, PrEP Program Stop Date", "PR, Is PrEP Program Active", 
              "PR, Reason for Stopping PrEP Program");
            conditions.hide.push("PR, Start date of ART program", "PR, Start date of Breast Feeding program",  
              "PR, Start date of IPT (Isoniazid Preventive Therapy) program", "PR, Start date of Pregnancy program", "PR, Start date of TB program", 
              "PR, ART Stage", "PR, Breast Feeding Stage", "PR, Pregnancy Stage", "PR, TB Stage", "PR, Start date of Breast Feeding Stage", 
              "PR, Start date of Pregnancy Stage", "PR, Start date of TB Stage", "PR, Breast Feeding Program Stop Date", "PR, IPT (Isoniazid Preventive Therapy) Program Stop Date", 
              "PR, Pregnancy Program Stop Date", "PR, TB Program Stop Date", "PR, Start date of ART Stage", "PR, ART Program Stop Date",
              "PR, Is Breast Feeding Program Active", "PR, Is IPT Program Active", "PR, Is Pregnancy Program Active", "PR, Is TB Program Active", 
            ...
            conditions.show.push("PR, Start date of TB program", "PR, TB Stage", "PR, Start date of TB Stage", "PR, TB Program Stop Date", 
              "PR, Is TB Program Active", "PR, Reason for Stopping TB Program");
            conditions.hide.push("PR, Start date of ART program", "PR, Start date of Breast Feeding program",  
              "PR, Start date of IPT (Isoniazid Preventive Therapy) program", "PR, Start date of Pregnancy program", "PR, Start date of PrEP program", 
              "PR, ART Stage", "PR, Breast Feeding Stage", "PR, Pregnancy Stage", "PR, Start date of Breast Feeding Stage", "PR, Start date of Pregnancy Stage",
               "PR, Breast Feeding Program Stop Date", "PR, IPT (Isoniazid Preventive Therapy) Program Stop Date", "PR, Pregnancy Program Stop Date", 
               ...
               "PR, Reason for Stopping Pregnancy Program", "PR, Is ART Program Active", "PR, Reason for Stopping ART Program", "PR, Reason for Stopping PrEP Program");
                 ...
                 conditions.hide.push("PR, Start date of ART program", "PR, Start date of Breast Feeding program", "PR, Start date of IPT (Isoniazid Preventive Therapy) program", 
                  ...
                  "PR, Breast Feeding Program Stop Date", "PR, IPT (Isoniazid Preventive Therapy) Program Stop Date", "PR, Pregnancy Program Stop Date","PR, PrEP Program Stop Date", "PR, TB Program Stop Date", 
                  ...
                  "PR, Reason for Stopping TB Program", "PR, Is ART Program Active", "PR, Is Breast Feeding Program Active", 
                  "PR, Is IPT Program Active", "PR, Is Pregnancy Program Active", "PR, Is PrEP Program Active", "PR, Is TB Program Active");
         }
         return conditions;
       }
